Det verkar som om Python i trinket.io konsolen är Python3, ty det svarar på samma sätt som python3 i Ubuntu 16.04.
python (d.v.s. python2) i Ubuntu svarar på samma sätt som bokens exempel. Borde använda trinket.io eller python3 för kapitel 3.
